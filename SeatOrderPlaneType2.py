...
total_removed = 0
correspond_bag = []
groupings = [1, 6, 2, 5, 3, 4, 4, 3, 5, 2, 6, 1]
seat_down_check = []
bag_time_or_shift = 0
shift_list = []
shift = 0
...
passenger_list.sort(reverse=False)
...
for i in range(len(passenger_list)):
    if int(people_and_columns.get(passenger_list[i])) == groupings[0] and int(people_and_rows.get(passenger_list[i])) > 41:
        shuffled_passengers.append(passenger_list[i])
    elif int(people_and_columns.get(passenger_list[i])) == groupings[1] and int(people_and_rows.get(passenger_list[i])) < 14:
        shuffled_passengers.append(passenger_list[i])
    else:
        pass
...
for i in range(len(passenger_list)):
    if int(people_and_columns.get(passenger_list[i])) == groupings[2] and int(people_and_rows.get(passenger_list[i])) > 41:
        shuffled_passengers.append(passenger_list[i])
    elif int(people_and_columns.get(passenger_list[i])) == groupings[3] and int(people_and_rows.get(passenger_list[i])) < 14:
            shuffled_passengers.append(passenger_list[i])
    else:
        pass
...
for x in range(len(groupings)):
    for i in range(len(passenger_list)):
        if int(people_and_columns.get(passenger_list[i])) == groupings[4] and int(people_and_rows.get(passenger_list[i])) > 41:
            shuffled_passengers.append(passenger_list[i])
        elif int(people_and_columns.get(passenger_list[i])) == groupings[5] and int(people_and_rows.get(passenger_list[i])) < 14:
            shuffled_passengers.append(passenger_list[i])
        else:
            pass
...
for x in range(len(groupings)):
    for i in range(len(passenger_list)):
        if int(people_and_columns.get(passenger_list[i])) == groupings[6] and int(people_and_rows.get(passenger_list[i])) > 41:
            shuffled_passengers.append(passenger_list[i])
        elif int(people_and_columns.get(passenger_list[i])) == groupings[7] and int(people_and_rows.get(passenger_list[i])) < 14:
            shuffled_passengers.append(passenger_list[i])
        else:
            pass

for i in range(len(passenger_list)):
    if int(people_and_columns.get(passenger_list[i])) == groupings[0] and int(people_and_rows.get(passenger_list[i])) < 42 and int(people_and_rows.get(passenger_list[i])) > 27:
        shuffled_passengers.append(passenger_list[i])
    elif int(people_and_columns.get(passenger_list[i])) == groupings[1] and int(people_and_rows.get(passenger_list[i])) > 13 and int(people_and_rows.get(passenger_list[i])) < 28:
        shuffled_passengers.append(passenger_list[i])
    else:
        pass
...
for i in range(len(passenger_list)):
    if int(people_and_columns.get(passenger_list[i])) == groupings[2] and int(people_and_rows.get(passenger_list[i])) < 42 and int(people_and_rows.get(passenger_list[i])) > 27:
        shuffled_passengers.append(passenger_list[i])
    elif int(people_and_columns.get(passenger_list[i])) == groupings[3] and int(people_and_rows.get(passenger_list[i])) > 13 and int(people_and_rows.get(passenger_list[i])) < 28:
            shuffled_passengers.append(passenger_list[i])
    else:
        pass
...
for x in range(len(groupings)):
    for i in range(len(passenger_list)):
        if int(people_and_columns.get(passenger_list[i])) == groupings[4] and int(people_and_rows.get(passenger_list[i])) < 42 and int(people_and_rows.get(passenger_list[i])) > 27:
            shuffled_passengers.append(passenger_list[i])
        elif int(people_and_columns.get(passenger_list[i])) == groupings[5] and int(people_and_rows.get(passenger_list[i])) > 13 and int(people_and_rows.get(passenger_list[i])) < 28:
            shuffled_passengers.append(passenger_list[i])
        else:
            pass
...
for x in range(len(groupings)):
    for i in range(len(passenger_list)):
        if int(people_and_columns.get(passenger_list[i])) == groupings[6] and int(people_and_rows.get(passenger_list[i])) < 42 and int(people_and_rows.get(passenger_list[i])) > 27:
            shuffled_passengers.append(passenger_list[i])
        elif int(people_and_columns.get(passenger_list[i])) == groupings[7] and int(people_and_rows.get(passenger_list[i])) > 13 and int(people_and_rows.get(passenger_list[i])) < 28:
            shuffled_passengers.append(passenger_list[i])
        else:
            pass
                        ...
                        if entering_plane[i] in already_blocked:
                            ...
                            for p in range(int(baggage.get(entering_plane[i]))):
                                ...
                                if int(people_and_rows.get(passenger_list[ind_d])) > int(people_and_rows.get(entering_plane[i])):
                                    ...
                                    pass
                            if len(beyond_blocker) >= (int(people_and_rows.get(entering_plane[i])) - 41):
