...
for i in range(len(passenger_list)):
    if int(people_and_columns.get(passenger_list[i])) == groupings[0] and int(people_and_rows.get(passenger_list[i])) > 20:
        shuffled_passengers.append(passenger_list[i])
    elif int(people_and_columns.get(passenger_list[i])) == groupings[1] and int(people_and_rows.get(passenger_list[i])) < 21:
        shuffled_passengers.append(passenger_list[i])
    else:
        pass
...
for i in range(len(passenger_list)):
    if int(people_and_columns.get(passenger_list[i])) == groupings[2] and int(people_and_rows.get(passenger_list[i])) > 20:
        shuffled_passengers.append(passenger_list[i])
    elif int(people_and_columns.get(passenger_list[i])) == groupings[3] and int(people_and_rows.get(passenger_list[i])) < 21:
            shuffled_passengers.append(passenger_list[i])
    else:
        pass
...
for x in range(len(groupings)):
    for i in range(len(passenger_list)):
        if int(people_and_columns.get(passenger_list[i])) == groupings[4] and int(people_and_rows.get(passenger_list[i])) > 20:
            shuffled_passengers.append(passenger_list[i])
        elif int(people_and_columns.get(passenger_list[i])) == groupings[5] and int(people_and_rows.get(passenger_list[i])) < 21:
            shuffled_passengers.append(passenger_list[i])
        else:
            pass
...
for x in range(len(groupings)):
    for i in range(len(passenger_list)):
        if int(people_and_columns.get(passenger_list[i])) == groupings[6] and int(people_and_rows.get(passenger_list[i])) > 20:
            shuffled_passengers.append(passenger_list[i])
        elif int(people_and_columns.get(passenger_list[i])) == groupings[7] and int(people_and_rows.get(passenger_list[i])) < 21:
            shuffled_passengers.append(passenger_list[i])
        else:
            pass
